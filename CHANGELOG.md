...
- Added restartable legacy-key migration and provider-credential pre-destroy R2 cleanup with the canonical Takosumi provider-configuration envelope, explicit default-Cloudflare binding semantics, and explicit standalone direct mode.
